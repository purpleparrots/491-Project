...
GameEngine.prototype.makeProtoEnemies = function() {
    ...
    this.addEntity(new AlienShip(this, (Math.round() * 2 * Math.PI), {x:1, y:0}, AM.getAsset("./images/alienship.png"), 75, 75, null, 100));
     this.addEntity(new Weapon(this, 0, {x:1,y:1},AM.getAsset("./images/weapon2.png"), 0, 0));
  //  this.generateWave();
